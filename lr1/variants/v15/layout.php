<?php
/**
 * Shared layout template for LR1 Variant 15 task pages
 */
...
function renderVariantLayout(string $content, string $taskName, string $bodyClass = ''): void
{
    ...
    $demoUrl = "/lr1/demo/{$currentTask}?from=v15";
    ?>
<!DOCTYPE html>
<html lang="uk">
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($taskName) ?> — Варіант 15 ЛР1</title>
...
<body class="body-with-header <?= htmlspecialchars($bodyClass) ?>">
    <header class="header-fixed">
        <div class="header-left">
            ...
            <a href="index.php" class="header-btn">← Варіант 15</a>
            <a href="<?= htmlspecialchars($demoUrl) ?>" class="header-btn header-btn-demo">Demo</a>
        </div>
        <div class="header-center"></div>
        <div class="header-right">
            <span class="header-variant-label">В-15</span>
