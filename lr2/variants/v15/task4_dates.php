 ...
 * Дати: 01-06-2024 та 25-12-2026 → 572 днів (81 тижнів і 5 днів)
 */
...
$date1 = $_POST['date1'] ?? '01-06-2024';
// зміщено другий рік на 2026 відповідно до умови
$date2 = $_POST['date2'] ?? '25-12-2026';
...
<div class="demo-card">
    ...
    <?php
        // додаткові обчислення для тижнів і днів
        $weeks = intdiv($days, 7);
        $extra = $days % 7;
        $detail = "{$days} днів";
        if ($weeks) {
            $detail .= " ({$weeks} тижнів" . ($extra ? " і {$extra} днів" : "") . ")";
        }
    ?>
    <div class="demo-result">
        <h3>Різниця</h3>
        <div class="demo-result-value"><?= $detail ?></div>
    </div>
    ...
    <div class="demo-section">
        ...
        <table class="demo-table">
            ...
            <tr>
                ...
                <td><span class="demo-tag demo-tag-success"><?= $detail ?></span></td>
            </tr>
        </table>
    </div>
