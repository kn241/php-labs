 ...
 *
 * Варіант 15: склади "вор сі ку тан бе мо рай лі жу пен", 4 імені, 3 складів
 */
 ...
 * Генерує кілька імен
 */
function generateMultipleNames(array $syllables, int $namesCount = 4, int $syllablesPerName = 3): array
{
    $names = [];
...
$syllablesInput = $_POST['syllables'] ?? 'вор сі ку тан бе мо рай лі жу пен';
    ...
    <form method="post" class="demo-form">
        ...
        <div class="form-row">
            ...
            <div>
                ...
                <input type="number" id="syllables_per_name" name="syllables_per_name" value="<?= $syllablesPerName ?>" min="3" max="4">
            </div>
        </div>
